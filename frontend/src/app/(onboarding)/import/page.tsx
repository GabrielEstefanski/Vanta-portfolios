          ...
          <div className={`bg-white/5 backdrop-blur-sm border border-white/5 rounded-lg p-8 relative overflow-hidden transform transition-all duration-1000 ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-sm max-w-md mx-auto">
                Escolha como deseja importar suas informações profissionais. 
                Seus dados serão tratados com segurança e privacidade.
              </p>
            </div>
          ...
          <div className={`bg-white/5 backdrop-blur-sm border border-white/5 rounded-lg p-8 relative overflow-hidden transform transition-all duration-1000 ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            <div className="mt-12">
              <Link 
                ...
                className="block w-full max-w-2xl mx-auto bg-white text-black font-medium py-3 rounded-lg hover:bg-white/90 transition-all duration-300 text-sm tracking-wide text-center shadow-lg shadow-white/5"
              >
                GERAR PORTFÓLIO
              </Link>
            </div>
